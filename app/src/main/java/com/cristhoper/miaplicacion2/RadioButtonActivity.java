    ...
    public void radioButtonClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.radioButton4:
                //Do something when radio button is clicked
                Toast.makeText(getApplicationContext(), "It seems like you feel TableLayout easy", Toast.LENGTH_SHORT).show();
                break;
    ...
    public void answer(View view){
        ...
        if (radioButtonId == -1){
            ...
            if (radioButtonId == R.id.radioButton1){
                ...
                Toast.makeText(this, "You selected FrameLayout", Toast.LENGTH_SHORT).show();
            }else if (radioButtonId == R.id.radioButton4){
                Toast.makeText(this, "You selected TableLayout", Toast.LENGTH_SHORT).show();
            }else if (radioButtonId == R.id.radioButton5){
                Toast.makeText(this, "You selected GridLayout", Toast.LENGTH_SHORT).show();
            }
